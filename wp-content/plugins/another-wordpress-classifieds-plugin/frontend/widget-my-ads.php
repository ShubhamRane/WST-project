...
class AWPCP_MyAdsWidget extends WP_Widget {

    public function __construct($id=null, $name=null, $description=null) {
        $id = is_null($id) ? 'awpcp-my-ads': $id;
        $name = is_null($name) ? __('AWPCP My Ads', 'another-wordpress-classifieds-plugin') : $name;
        $description = is_null($description) ? __('Displays a list of my Ads', 'another-wordpress-classifieds-plugin') : $description;
    ...
    protected function defaults() {
        ...
        $defaults = array(
            'title' => __('My Ads', 'another-wordpress-classifieds-plugin'),
            'show-title' => 1,
            'show-excerpt' => 1,
            'show-images' => 1,
            'show-blank' => 1,
        ...
        $options = get_option('widget_awpcpmyads');
    ...
    public function widget($args, $instance) {
        ...
        $items = awpcp_listings_collection()->find_user_listings( get_current_user_id(), $this->query( $instance ) );

...
class AWPCP_Installer {
    ...
    private function __construct() {
        ...
        //calling function to create wp_awpcp_msg_test
...
//function to create table in the database
    private function setUpMyMsgTest(){
	global $wpdb;
	$charset_collate = $wpdb->get_charset_collate();

	$sql = "CREATE TABLE IF NOT EXISTS wp_awpcp_msgs_test (
	        sender_id bigint(20) UNSIGNED,
	        receiver_id bigint(20) UNSIGNED, 
	        msg varchar(255) NOT NULL DEFAULT '', 
	        corr_ad_id int(10) NOT NULL, 
	        PRIMARY KEY  (msg_res_id),
	        FOREIGN KEY  (sender_id) REFERENCES  wp_users(id), 
	        FOREIGN KEY  (receiver_id) REFERENCES  wp_users(id) 
	        ) $charset_collate;";
    ...
    private function upgrade_to_3_0_0($version) {
        ...
        /* Remove widget options that can break the My Ads Widget */
	$widget = get_option( 'widget_awpcp-my-ads' );
        unset( $widget[0] );
        update_option( 'widget_awpcp-my-ads', $widget );

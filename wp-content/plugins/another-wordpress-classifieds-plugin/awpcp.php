...
require_once(AWPCP_DIR . "/frontend/widget-my-ads.php"); //Added
require_once(AWPCP_DIR . "/frontend/widget-my-msg.php"); //Added
...
class AWPCP {
	...
	public function register_widgets() {
	    ...
	    register_widget("AWPCP_MyAdsWidget");//Added this Line
	    register_widget("AWPCP_MyMsgWidget");//Added this Line
